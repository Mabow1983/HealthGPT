                ...
                _Concurrency.Task {
                    ...
                    healthDataFetcher.requestAuthorization { success in
                        if success {
                            ...
                            // fetch insulin and glucose
                            group.enter()
                            healthDataFetcher.fetchLastTwoWeeksGlucose { glucoseData in
                                print(glucoseData)
                                for day in 0...13 {
                                    healthData[day].glucose = glucoseData[day]
                                }
                            ...
                            group.enter()
                            healthDataFetcher.fetchLastTwoWeeksInsulin { insulinData in
                                print(insulinData)
                                for day in 0...13 {
                                    healthData[day].insulin = insulinData[day]
                                }
                                print("Insulin Data", insulinData)
                                group.leave()
                            }
